...
function cshero_post_nav() {
	...
	<nav class="navigation post-navigation clearfix" role="navigation">
		<div class="nav-links">
			<?php
				previous_post_link( '<div class="nav-previous">%link</div>', _x( '<span class="btn btn-default"><i class="fa fa-chevron-circle-left"></i>PREVIOUS POST</span>', THEMENAME ) );
				next_post_link(     '<div class="nav-next">%link</div>',     _x( '<span class="btn btn-default">NEXT POST<i class="fa fa-chevron-circle-right"></i></span>', THEMENAME ) );
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
