...
<div class="<?php echo esc_attr(trim($css_class)); ?>">
	<div class="cs_separator_title">
        ...
        <?php if($title!=''): ?><<?php echo esc_attr($heading_size); ?><?php if($text_transform){ echo " style='text-transform: $text_transform;'"; } ?>><?php echo $title; ?></<?php echo esc_attr($heading_size); ?>><?php endif; ?>
