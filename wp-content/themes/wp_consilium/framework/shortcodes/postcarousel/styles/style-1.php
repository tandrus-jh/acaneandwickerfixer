...
?>
<div id="cs_carousel_post<?php echo esc_attr($date); ?>" class="cs-carousel cs-carousel-post style-1 <?php echo esc_attr($cl_show).' '.esc_attr($el_class); ?> <?php echo $same_height?'sameheight':'';?>">
                                    ...
                                    <div class="cs-carousel-header">
                                        ...
                                        <div class="cs-carousel-details">
                                            <?php if ($read_more != '') { ?>
                                                    <?php
                                                        if ($read_more != '-1') {
                                                            echo '<div class="cs-read-more"><a href="' . esc_url(get_permalink()) . '" title="' . esc_attr($read_more) . '" class="read-more-link"><i class="ion-plus-round"></i></a></div>';
                                                        }
                                                    ?>
                                            <?php } ?>
                                        </div>
