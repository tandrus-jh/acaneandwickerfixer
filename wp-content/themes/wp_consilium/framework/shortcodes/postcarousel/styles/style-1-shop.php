...
?>
<div id="cs_carousel_post<?php echo esc_attr($date); ?>" class="cs-carousel cs-carousel-post-shop cs-carousel-style-1-shop <?php echo esc_attr($cl_show).' '.esc_attr($el_class); ?> <?php echo $same_height?'sameheight':'';?>">
                                ...
                                <div class="cs-carousel-header">
                                    ...
                                    if (has_post_thumbnail()) {
                                        if($crop_image == true || $crop_image == 1){
                                            ...
                                            echo '<a title="<?php the_title(); ?>" href="<?php the_permalink(); ?>" rel=""><img alt="" class="attachment-featuredImageCropped" src="'. esc_attr($image_resize['url']) .'" /></a>';
                                        }else{
                                        ...
                                        <div class="cs-carousel-post-meta">
                                            ...
                                            <?php if($read_more): ?>
                                                <div class="cs-carousel-post-read-more">
                                                    <a class="btn" href="<?php the_permalink(); ?>"><?php echo esc_attr($read_more); ?></a>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
