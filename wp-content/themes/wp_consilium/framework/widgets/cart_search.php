...
class WC_Widget_Cart_Search extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        <div class="widget_cart_search_wrap">
            ...
            <div class="shopping_cart_dropdown">
                ...
                <a href="<?php echo $woocommerce->cart->get_cart_url(); ?>" class="btn btn-primary btn-white left wc-forward"><?php _e( 'Cart', 'woocommerce' ); ?></a>
    ...
    function form( $instance ) {
		...
		<p>
            ...
            <input id="<?php echo esc_attr( $this->get_field_id('show_cart') ); ?>" name="<?php echo esc_attr( $this->get_field_name('show_cart') ); ?>" type="checkbox" <?php if ( isset($instance['show_cart'])) echo 'checked="checked"'; ?> value="1" />
        </p>
		<p>
            <label for="<?php echo esc_attr($this->get_field_id('show_search')); ?>"><?php _e( 'Show Search:', THEMENAME ); ?></label>
             <input id="<?php echo esc_attr( $this->get_field_id('show_search') ); ?>" name="<?php echo esc_attr( $this->get_field_name('show_search') ); ?>" type="checkbox" <?php if ( isset($instance['show_search'])) echo 'checked="checked"'; ?>  value="1" />
        </p>
    <?php
