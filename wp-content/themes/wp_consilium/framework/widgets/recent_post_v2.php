...
class CS_Recent_Post_Widget_V2 extends WP_Widget {
    ...
    function form($instance) {
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('show_date') ); ?>" name="<?php echo esc_attr( $this->get_field_name('show_date') ); ?>" <?php if(!isset($instance['show_date'])) echo 'checked="checked";' ?> type="checkbox" value="1" <?php checked( '1', $show_date ); ?> />
        </p>
        <p>
