    ...
    <header id="header-sticky" class="sticky-header">
        <div class="container">
            <div class="row">
                ...
                <?php
                    $class=(is_active_sidebar('cshero-header-content-widget-1'))?'col-xs-9 col-sm-9 col-md-9 col-lg-9 active_cart_search no-padding-right':'col-xs-9 col-sm-9 col-md-9 col-lg-9';
                ?>
                <div class="sticky-menu <?php echo $class;?> cs_menu_position_<?php echo $smof_data["menu_position"]; ?>">
