...
<div class="header header-v3">
    ...
    <header id="cshero-header" class="<?php if($header_setings->header_fixed == '1'){ echo ' transparentFixed';} ?>" <?php echo $header_setings->styles; ?>>
        <div class="container">
            <div class="row">
            	<div id="menu-1" class="main-menu main-menu-left col-xs-5 col-sm-5 col-md-5 col-lg-5">
				...
				<div id="menu-2" class="main-menu main-menu-right col-xs-5 col-sm-5 col-md-5 col-lg-5">
					<div class="main-menu-content cshero-menu-dropdown clearfix nav-menu cshero-mobile">
				    <?php
...
<?php get_template_part('framework/headers/sticky-header','photography'); ?>