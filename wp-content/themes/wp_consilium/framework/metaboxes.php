...
class CsheroFrameworkMetaboxes {
	...
	function admin_script_loader() {
		...
		if (is_admin() && ($pagenow=='post-new.php' || $pagenow=='post.php')) {
			...
			wp_enqueue_script('jquery-colorpicker', get_template_directory_uri().'/framework/assets/js/colpick.js');
			wp_enqueue_script('cshero-upload', get_template_directory_uri().'/js/upload.js');
			wp_enqueue_script('jquery-easytabs', get_template_directory_uri().'/framework/assets/js/jquery.easytabs.min.js');
	...
	public function add_meta_boxes()
	{
		...
		$this->add_meta_box('post_options', __('Page Options',THEMENAME), 'page');

		$this->add_meta_box('post_video', __('Video Settings',THEMENAME), 'post');
		$this->add_meta_box('post_audio', __('Audio Settings',THEMENAME), 'post');
		$this->add_meta_box('post_quote', __('Quote Settings',THEMENAME), 'post');
		$this->add_meta_box('post_link', __('Link Settings',THEMENAME), 'post');

		$this->add_meta_box('team', __('Team Setting',THEMENAME), 'team');
		$this->add_meta_box('client', __('Client Url',THEMENAME), 'myclients');
		$this->add_meta_box('portfolio', __('Portfolio Setting',THEMENAME), 'portfolio');
	}
