...
<div id="cs-blog-metabox" class='cs_metabox' style="display: none;">
	...
	<ul class='category-tabs'>
	   ...
	   <li class='cs-tab'><a href="#tabs-body"><i class="dashicons dashicons-welcome-write-blog"></i> <?php echo _e('BODY',THEMENAME);?></a></li>
	   <li class='cs-tab'><a href="#tabs-header"><i class="dashicons dashicons-menu"></i> <?php echo _e('HEADER',THEMENAME);?></a></li>
	   <li class='cs-tab'><a href="#tabs-page-title"><i class="dashicons dashicons-admin-home"></i> <?php echo _e('PAGE TITLE & BREADCRUMB',THEMENAME);?></a></li>
	   <li class='cs-tab'><a href="#tabs-sidebar"><i class="dashicons dashicons-slides"></i> <?php echo _e('SIDEBAR',THEMENAME);?></a></li>
	   <li class='cs-tab'><a href="#tabs-footer"><i class="dashicons dashicons-archive"></i> <?php echo _e('FOOTER',THEMENAME);?></a></li>
 	</ul>
 	<div class='cs-tabs-panel'>
	 	...
	 	<div id="tabs-body">
			<p class="cs_info"><i class="dashicons dashicons-format-image"></i><?php echo _e('Following options only work in boxed mode:',THEMENAME);?></p>
			<?php
		...
		<div id="tabs-header">
			...
			<p class="cs_info"><i class="dashicons dashicons-admin-post"></i><?php echo _e('Header Fixed Setting:',THEMENAME);?></p>
			<?php
			...
			<p class="cs_info"><i class="dashicons dashicons-format-image"></i><?php echo _e('Background Setting:',THEMENAME);?></p>
			<?php
			...
			<p class="cs_info"><i class="dashicons dashicons-lightbulb"></i><?php echo _e('Sticky Header',THEMENAME); ?></p>
			<?php
			...
			?>
			<p class="cs_info"><i class="dashicons dashicons-megaphone"></i><?php echo _e('Manage Locations',THEMENAME); ?></p>
			<?php
			$menus = array();
			$menus[''] = 'Default';
		...
		<div id="tabs-page-title">
			...
			<p class="cs_info"><i class="dashicons dashicons-flag"></i><?php echo _e('Breadcrumb',THEMENAME); ?></p>
			<?php
			$this->select(	'breadcrumb',
					'Breadcrumbs',
					array('defualt' => 'Default','custom' => 'Show', 'hide' => 'Hide'),
					'',
					''
			);
			?>
