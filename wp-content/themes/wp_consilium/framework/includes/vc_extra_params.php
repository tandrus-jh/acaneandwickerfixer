    ...
    if (shortcode_exists('vc_row')) {
        ...
        vc_add_param("vc_row", array(
            ...
            "value" => array(
                ...
                "Background Retro Line" => "bg-rowStyle-retro",
                "Background Retro Line Bottom" => "bg-rowStyle-retro-bottom",
                "Background Retro Line Top" => "bg-rowStyle-retro-top",
                "Border Column Gray" => "cs-border-column",
                "Full Width Shop" => "cs-full-width",
                "More Features" => "cs-more-features"
            )
        )
        );
    ...
    if (shortcode_exists('vc_column')) {
        ...
        vc_add_param("vc_column", array(
            ...
            "value" => array(
                ...
                "Title Unblemished Color" => "title-unblemished",
                "Title Style Icon Only Agency" => "title-style-icon",
                "Title Style Icon White Only Agency" => "title-style-icon-white",
                "Title Style Line Only Agency" => "title-style-line",
                "Title Primary Color Only Retro" => "title-style-colorprimary-retro",
                "Title Primary Color Only Retro 2" => "title-style-colorprimary-retro2",
                "Title White Color Only Retro" => "title-style-colorwhite-retro",
                "Features Icons Only University" => "cs-feature-icons"
            ),
