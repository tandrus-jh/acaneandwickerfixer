                   ...
                   <div class="cs-carousel-container">
                        ...
                        if (has_post_thumbnail()){
                            ...
                            if($crop_image == true || $crop_image == 1){
                                ...
                                echo '<div class="cs-team-featured-img"><img class="attachment-featuredImageCropped" src="'. esc_attr($image_resize['url']) .'" /></div>';
                            }else{
                               echo '<div class="cs-team-featured-img"><img src="'. esc_attr($attachment_image[0]) .'" /></div>';
                            }
                        }
                        ?>
