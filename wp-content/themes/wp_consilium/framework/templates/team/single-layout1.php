...
$show_description = $smof_data['team_show_description'];
...
<article id="cs_post_<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="row cs-item-team">
		<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 cs-team-details">
		...
		<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 cs-team-media">
			<?php
