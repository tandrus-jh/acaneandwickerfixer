                    ...
                    <?php if ($show_title == true || $show_title == 1 || $show_category == true || $show_category == 1) { ?>
                        <div class="cs-testimonial-content">
                            <?php if ($show_title == true || $show_title == 1) { ?>
                                <h3 class="cs-testimonial-title">
                                    <span class="cs-testimonial-title-style"><?php the_title() ?></span>
                                    <?php if ($show_category == true || $show_category == 1) { ?>
                                        <span class="cs-testimonial-category"><?php echo strip_tags (get_the_term_list($post->ID, 'testimonial_category', '', ', ', '')); ?></span>
                                    <?php } ?>
                                </h3>
                            <?php } ?>                    
                        </div>
