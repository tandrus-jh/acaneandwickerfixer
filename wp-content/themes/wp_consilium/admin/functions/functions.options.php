...
if (!function_exists('of_options')) {
    function of_options()
    {
        ...
        $of_options[] = array("name" => "Demo Content",
            ...
            "icon" => true,
            "type" => "info");
        $all_data = (get_option('cs_consilium_dummy',0))?'disabled':'';
        $slider = (get_option('cs_consilium_dummy_slider',0))?'disabled':'';
        $grid = (get_option('cs_consilium_dummy_grid',0))?'disabled':'';
        $widget = (get_option('cs_consilium_dummy_widget',0))?'disabled':'';
        ...
        $of_options[] = array("name" => "Select Theme",
            "desc" => "<select name='select_data' id='select_data'>
                            <option value=''>No Data</option>
                            <option value='widget' ".$widget.">Widget Config</option>
                            <option value='grid' ".$grid.">Ess Grid</option>
                            <option value='slider' ".$slider.">Slider</option>
                            <option value='all' ".$all_data.">All Sample Data</option>
                        </select>
                        <br />
                        <input type='button' name='sample' id='sample' value='Import Now' /><br />
                        <span id='msg'>You Need install visual composer plugin to dummy data.</span>",
            "id" => "theme",
            "std" => "",
            "type" => "select",
            "options" => array(
                '' => 'WP Consilium',
                'agency' => 'WP Consilium Agency',
                'shop' => 'WP Consilium Shop',
                'retro' => 'WP Consilium Retro',
                'blog' => 'WP Consilium Blog',
                'corporate' => 'WP Consilium Corporate',
...
// begin logo
        ...
        $of_options[] = array("name" => "Logo",
            ...
            "id" => "logo",
            "std" => get_template_directory_uri() . "/images/logo/main_logo.png",
            "mod" => "",
            "type" => "media");
        ...
        $of_options[] = array("name" => "Logo Header Sticky",
            ...
            "std" => get_template_directory_uri() . "/images/logo/sticky_main_logo.png",
            "mod" => "",
            "type" => "media");
...
// begin header
        ...
        switch (getCSSite()) {
            case '-shop':
            case '-vintage':
                $header_arr = array("v2" => get_template_directory_uri() . "/images/header/header2.jpg");
                break;
            case '-photography':
                $header_arr = array("v3" => get_template_directory_uri() . "/images/header/header3.jpg");
                break;
            case '-corporate':
                $header_arr = array("v4" => get_template_directory_uri() . "/images/header/header4.jpg");
                break;
            case '-blog':
                $header_arr = array("v5" => get_template_directory_uri() . "/images/header/header5.jpg");
                break;
            case '-retro':
                $header_arr = array("v6" => get_template_directory_uri() . "/images/header/header6.jpg");
                break;
            case '-university':
                $header_arr = array("v8" => get_template_directory_uri() . "/images/header/header6.jpg");
                break;
            default:
                $header_arr = array("v1" => get_template_directory_uri() . "/images/header/header1.jpg");
                break;
        }
...
// begin menu
        ...
        $of_options[] = array("name" => "Dropdown Menu Width",
            "desc" => "Use a number with 'px', ex: 160px",
...
//begin hidden sidebar
        $of_options[] = array("name" => "Hidden Sidebar",
            "type" => "heading");
        $of_options[] = array("name" => "Hidden Sidebar Config",
            "desc" => "",
            "id" => "header_info",
            "std" => "<h3 style='margin: 0;'>Hidden Sidebar Config</h3>",
            "icon" => true,
            "type" => "info");
        $of_options[] = array("name" => "Enable Hidden Sidebar",
                "desc" => "",
                ...
                "off" => "No",
                "type" => "switch");
        $of_options[] = array("name" => "Enable Hover",
                "desc" => "User Mouse hover to display sidebar. Only use when position is top",
                "id" => "enable_hidden_hover",
                "std" => 0,
                "on" => "Yes",
                "off" => "No",
                "type" => "switch");
        $of_options[] = array("name" => "Position",
            "desc" => "Select position display hidden sidebar.",
        ...
        $of_options[] = array("name" => "Width",
            "desc" => "The width of the menu (when using left/right position)",
            "id" => "hidden_sidebar_width",
            "std" => "220px",
            "type" => "text");
        $of_options[] = array("name" => "Height",
            "desc" => "The height of the menu (when using top/bottom position)",
            "id" => "hidden_sidebar_height",
            "std" => "320px",
            "type" => "text");
//end hidden menu
// begin bottom
        $of_options[] = array("name" => "Bottom",
            "type" => "heading");

        $of_options[] = array("name" => "Bottom Info",
            "desc" => "",
            "id" => "bottom_info",
            "std" => "<h3 style='margin: 0;'>Bottom Options</h3>",
            "icon" => true,
            "type" => "info");

        $of_options[] = array("name" => "Bottom Widgets",
            "desc" => "Display bottom widgets.",
            "id" => "bottom_1_widgets",
            "std" => 1,
            "on" => "Yes",
            "off" => "No",
        ...
        $of_options[] = array("name" => "Number of Bottom Columns",
            "desc" => "Select the number of columns to display in the bottom.",
            "id" => "bottom_1_widgets_columns",
            "std" => "2",
            "options" => array('1' => '1', '2' => '2', '3' => '3', '4' => '4'),
            "fold" => "bottom_1_widgets",
            "type" => "select");
        $of_options[] = array("name" => "Class Bottom Widget 1",
            "desc" => "Class follow the Bootstrap 3",
            "id" => "bottom_1_widgets_1",
            "std" => "col-xs-12 col-sm-6 col-md-3 col-lg-3",
            "fold" => "bottom_1_widgets",
            "type" => "text");
        $of_options[] = array("name" => "Class Bottom Widget 2",
            "desc" => "Class follow the Bootstrap 3",
            "id" => "bottom_1_widgets_2",
            "std" => "col-xs-12 col-sm-6 col-md-3 col-lg-3",
            "fold" => "bottom_1_widgets",
            "type" => "text");
        $of_options[] = array("name" => "Class Bottom Widget 3",
            "desc" => "Class follow the Bootstrap 3",
            "id" => "bottom_1_widgets_3",
            "std" => "col-xs-12 col-sm-6 col-md-3 col-lg-3",
            "fold" => "bottom_1_widgets",
            "type" => "text");
        $of_options[] = array("name" => "Class Bottom Widget 4",
            "desc" => "Class follow the Bootstrap 3",
        ...
        $of_options[] = array("name" => "Background Image",
            "desc" => "Select an image or insert an image url to use for the bottom area backgroud.",
            "id" => "bottom_1_bg_image",
            "std" => "",
            "mod" => "",
            "fold" => "bottom_1_widgets",
            "type" => "media");
        ...
        $of_options[] = array("name" => "100% Background Image",
            "desc" => "The bottom background image display at 100% in width and height and scale according to the browser size.",
            "id" => "bottom_1_bg_full",
            "std" => 0,
            "on" => "Yes",
            "off" => "No",
        ...
        $of_options[] = array("name" => "Background Position",
            ...
            "fold" => "bottom_1_widgets",
            "options" => $body_pos);
        $of_options[] = array("name" => "Bottom Padding",
        ...
        $of_options[] = array("name" => "Bottom Color Option",
            "desc" => "",
            "id" => "bottom_1_color_option",
            "std" => "<h3 style='margin: 0;'>Bottom Color Option</h3>",
            "icon" => true,
            "type" => "info");
        $of_options[] = array("name" => "Bottom Background Color",
            "desc" => "Bottom Background Color.",
            "id" => "bottom_1_top_bg_color",
            "std" => "",
            "type" => "color");
        $of_options[] = array("name" => "Bottom Headings Color",
            "desc" => "Controls the text color of the bottom heading font.",
            "id" => "bottom_1_headings_color",
            "std" => "",
            "type" => "color");
        $of_options[] = array("name" => "Bottom Font Color",
            "desc" => "Controls the text color of the bottom font.",
            "id" => "bottom_1_text_color",
            "std" => "",
            "type" => "color");
        $of_options[] = array("name" => "Bottom Link Color",
            "desc" => "Controls the text color of the bottom link font.",
            "id" => "bottom_1_link_color",
            "std" => "",
            "type" => "color");
        $of_options[] = array("name" => "Bottom Link Hover Color",
            "desc" => "Bottom Link Hover Color.",
...
// begin title bar - breadcrumbs
        ...
        $of_options[] = array("name" => "Page Title Style",
                ...
                "std" => "",
                "options" => array('' => 'base', 'corporate' => 'corporate'),
                "type" => "select");
...
// begin Typography
        ...
        $of_options[] = array("name" => "Body Font Family Selector",
            ...
            "std" => "body, .q_counter_holder span.counter, .cs-testimonial-header h3.cs-title, .cs-team .cs-header h3.cs-title, .wpb_accordion_section .wpb_accordion_header a, .q_counter_holder p.counter_text",
            "type" => "textarea"
        );
        ...
        $of_options[] = array("name" => "Header Font Family Selector",
            ...
            "std" => "body h2, body h3, body h4, .cshero-menu-dropdown > ul > li > a, #sticky-nav-wrap ul.sticky-nav > li > a, .cshero-menu-dropdown > ul > li.mega-menu-item > ul.colimdi > li > a, .menu-pages .menu > ul > li > a, .cs-recent-post-v1 ul li a, input[type='submit'],  .cs-fancy-box .cs-title-main, .widget_recent_comments ul li a, h3.cs-team-title, .cs-testimonial-content .cs-testimonial-title, .page-title, #footer-top h3.wg-title,  #cs-breadcrumb-wrapper .cs-breadcrumbs a,
#cs-breadcrumb-wrapper .cs-breadcrumbs span, .woocommerce-breadcrumb, .woocommerce-breadcrumb a, .product_title, cs-shopcarousel-style-1-shop h3.cs-title, .primary-sidebar .widget_recent_entries ul li a, blockquote > p:before, blockquote > p:after",
            "type" => "textarea"
        );
...
#order_review_heading",
        ...
        $of_options[] = array("name" => "Other Font Family Selector 1",
            ...
            "std" => "a.read-more-link, h3.title-main-body, .tab-holder ul.nav li a, .cs-popular .cs-meta .date, .cs-popular .cs-details > h4, .cs-popular .cs-details .readmore, .getTouchSidebar > li i, .cs-latest-twitter a i, strong,
.cs-blog-quote .cs-blog-content .cs-content-text span.author ",
            "type" => "textarea"
        );
        /* Other Font 2 */
        ...
        $of_options[] = array("name" => "Other Font Family Selector 2",
            ...
            "std" => "h3.ww-title, h3.cs-title,  .ww-subtitle, .cs-breadcrumbs a, .cs-breadcrumbs span, .home .ww-fancy-box.fancy-box-style-1 .ww-title-main",
            "type" => "textarea"
        );
        /* Other Font 3 */
        ...
        $of_options[] = array("name" => "Other Font Family Selector 3",
            ...
            "std" => ".cs-blog .cs-blog-info li, .cs-testimonial-content .cs-title.cs-testimonial-category",
            "type" => "textarea"
        );
        /* Other Font 4 */
        ...
        $of_options[] = array("name" => "Other Font Family Selector 4",
            ...
            "std" => "body h5, .cs-navigation .page-numbers,  .btn, .button, button, .cs_call_to_action .wpb_call_text, a.read-more-link.btn",
            "type" => "textarea"
        );
        /* Other Font 5 */
...
// begin team
        ...
        $of_options[] = array("name" => "Post Options",
            "desc" => "",
            "id" => "team_post_options",
            "std" => "<h3 style='margin: 0;'>Post Options</h3>",
            "icon" => true,
            "type" => "info");
        $of_options[] = array( "name" => "About title",
            "desc" => "Please enter about title of post team detail.",
            "id" => "team_about_title",
            "std" => "A little about me...",
            "type" => "text");
        $of_options[] = array( "name" => "Show Description",
            "desc" => "Show or hide description of post team detail.",
            "id" => "team_show_description",
            "std" => 1,
            "on" => "Yes",
            "off" => "No",
            "type" => "switch");
        $of_options[] = array( "name" => "Excerpt Length",
            ...
            "std" => "100",
            "fold" => "team_show_description",
            "type" => "text");
        $of_options[] = array( "name" => "Show Socials",
            "desc" => "Show or hide socials of post team detail.",
        ...
        $of_options[] = array("name" => "Carousel Options",
            "desc" => "",
            "id" => "team_carousel_options",
            "std" => "<h3 style='margin: 0;'>Carousel Options</h3>",
            "icon" => true,
            "type" => "info");
        $of_options[] = array( "name" => "Title",
            "desc" => "Please enter title of carousel page team detail.",
            "id" => "team_cr_title",
            "std" => 'Lastest Work by ',
            "type" => "text");
        $of_options[] = array( "name" => "Crop Images",
            "desc" => "Crop or Not image of carousel page team detail.",
            "id" => "team_cr_crop_image",
            "std" => 1,
            "on" => "Yes",
            "off" => "No",
            "type" => "switch");
...
// begin portfolio
        ...
        $of_options[] = array( "name" => "Post per page",
            ...
            "type" => "text");
// begin Icon Font
        $of_options[] = array("name" => "Library",
            "type" => "heading"
        );
        $of_options[] = array("name" => "Bootstrap & jQuery",
            "desc" => "",
            "id" => "get_bootstrap",
            "std" => "<h3 style='margin: 0;'>Bootstrap</h3>",
            "icon" => true,
            "type" => "info");
        $of_options[] = array( "name" => "Bootstrap CDN",
            "desc" => "Default local (Suggest turn off).",
            "id" => "get_bootstrap_cdn",
            "std" => 0,
            "on" => "Yes",
            "off" => "No",
            "type" => "switch");

        $of_options[] = array("name" => "Icon Font",
            "desc" => "",
            "id" => "icon_font",
            "std" => "<h3 style='margin: 0;'>Icon Font</h3>",
            "icon" => true,
            "type" => "info");
        $of_options[] = array( "name" => "Use Font Awesome",
            "desc" => "Use Font Awesome.",
            "id" => "use_font_awesome",
            "std" => 1,
            "on" => "Yes",
            "off" => "No",
            "type" => "switch");
        $of_options[] = array( "name" => "Load Font Awesome CDN",
            "desc" => "Default local.",
            "id" => "use_font_awesome_cdn",
            "std" => 0,
            "on" => "Yes",
            "off" => "No",
            "fold" => "use_font_awesome",
            "type" => "switch");
        $of_options[] = array( "name" => "Use Font Ionicons",
            "desc" => "Use Font Ionicons.",
            "id" => "use_font_ionicons",
            "std" => 1,
            "on" => "Yes",
            "off" => "No",
            "type" => "switch");
        $of_options[] = array( "name" => "Load Font Ionicons CDN",
            "desc" => "Default local.",
            "id" => "use_font_ionicons_cdn",
            "std" => 0,
            "on" => "Yes",
            "off" => "No",
            "fold" => "use_font_ionicons",
            "type" => "switch");
// end Icon Font SS
// begin 404
        ...
        $of_options[] = array("name" => "Username",
            "desc" => "Your Envato username.",
            "id" => "username_evt",
            "std" => "",
            "type" => "text"
        );
		$of_options[] = array("name" => "API key",
            "desc" => "<p>You can find API key by visiting your Envato Account page.</p>
			<p>
			<input id='submit_theme_update' class='button' type='submit' value='Save' name='submit'>
			<span class='mesage_theme_update'></span></p>",
            "id" => "api_key_evt",
            "std" => "",
            "type" => "text"
        );
