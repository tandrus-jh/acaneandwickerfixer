<?php
/**
 * Envato Theme Upgrader class to extend the Theme_Upgrader class.
 *
 * @package     Envato Updater
...
if ( class_exists( 'Theme_Upgrader' ) && ! class_exists( 'Envato_WordPress_Theme_Upgrader' ) ) {
    class Envato_WordPress_Theme_Upgrader extends Theme_Upgrader
    {
        ...
        public function upgrade_theme( $theme_name = '', $allow_cache = true )
        {
            ...
            $result->success               = $this->do_upgrade_theme( $installed_theme['Name'], $marketplace_theme_data->item_id);
        ...
        {
            return $installed_theme['Name'] == $purchased_theme->theme_name AND $installed_theme['Author'] == $purchased_theme->author_name;
        }
